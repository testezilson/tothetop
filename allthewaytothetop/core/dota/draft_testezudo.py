...
class DotaDraftTestezudoAnalyzer:
    ...
    def _path(self, filename):
        for path in (
            path_in_models(filename),
            path_in_data(filename),
            os.path.join(os.environ.get("DOTA_DRAFT_DIR", ""), filename),
            os.path.join(self.testezudo_dir, filename),
        ):
    ...
    def analyze_draft(
        ...
        return {
            ...
            "draft_strength_multiplier": float(S),
